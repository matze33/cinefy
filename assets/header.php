        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          <ul class="navbar-nav ms-auto me-sm-2 mt-2 mt-lg-0">
            <li class="nav-item active me-3">
              <a class="nav-link" href="index.php#">Start <span
            ...
            <li class="nav-item me-3">
              <a class="nav-link" href="index.php#plans">Tarife & Preise</a>
            </li>
            <li class="nav-item me-3">
              <a class="nav-link" href="index.php#team">Unser Team</a>
            </li>
            <li class="nav-item me-3">
              <a class="nav-link" href="index.php#contact">Kontakt</a>
            </li>
            <li class="nav-item me-3">
              <a class="nav-link" href="index.php#location">Standort</a>
            </li>
